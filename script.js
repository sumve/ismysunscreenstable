function checkPhotostability() {
    ...
    // Define all aliases
    const avobenzone = ["avobenzone", "butyl methoxydibenzoylmethane", "bmbm", "bmdbm", "parsol1789", "eusolex 9020"];
    const octocrylene = ["octocrylene", "2-ethylhexyl 2-cyano-3,3-diphenylacrylate"];
    const octinoxate = ["octinoxate", "ethylhexyl methoxycinnamate", "omc", "ehmc", "parsol mcx"];
    ...
    if (hasAvobenzone && hasOctinoxate && hasOctocrylene) {
      result = "❌ Not Recommended – Avobenzone + Octinoxate + Octocrylene is unstable.";
      ...
      result = "⚠️ Conditionally OK – Has unstable combo, but Zinc/Titanium might help.";
